...
func (*Ad) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad_45f6b0bbb7e6ab2e, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/ad.proto", fileDescriptor_ad_45f6b0bbb7e6ab2e)
}

var fileDescriptor_ad_45f6b0bbb7e6ab2e = []byte{
